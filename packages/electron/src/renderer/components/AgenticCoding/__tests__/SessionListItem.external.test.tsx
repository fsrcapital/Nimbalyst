...
vi.mock('../../../store', async () => {
  ...
  return Object.fromEntries(['sessionOrChildProcessingAtom', 'sessionProcessingAtom', 'sessionActiveSubagentCountAtom', 'sessionUnreadAtom', 'sessionPendingPromptAtom', 'sessionHasPendingInteractivePromptAtom', 'reparentSessionAtom', 'refreshSessionListAtom', 'sessionShareAtom', 'sessionWakeupAtom', 'sessionLastActivityAtom'].map(key => [key, () => empty]));
});
